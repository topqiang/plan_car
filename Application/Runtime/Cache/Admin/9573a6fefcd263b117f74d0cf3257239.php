...
<link rel="stylesheet" href="/elem/Public/Admin/css/expand.css" type="text/css" media="screen" />
<script type="text/javascript" src="/elem/Public/Admin/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/elem/Public/Admin/js/ajax_submit.js"></script>
</head>
<body id="login">
    <div id="login-wrapper" class="png_bg">
        <div id="login-top">
            <a href="#"><img id="logo" src="/elem/Public/Admin/images/logo.png" alt="logo" style="width:200px;" /></a>
        </div>
