...
<head>
    ...
    <script type="text/javascript" src="/elem/Public/Admin/js/menu.simpla.jquery.js"></script>
</head>
<body>
    <!--左部页面-->
    <div id="sidebar">
        <div id="sidebar-wrapper">
            <!--logo-->
            <a href="#">
                <img id="logo" src="/elem/Public/Admin/images/logo.png" width="188" alt="logo"/>
            </a>
            <!--欢迎  退出-->
            ...
            <ul id="main-nav">
                <li>
                    <a href="<?php echo U('Goods/GoodsList');?>" class="nav-top-item">商品管理</a>
                    <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="<?php echo U('Order/orderlist');?>" target="main">订单列表</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="nav-top-item">商家管理</a>
                    <ul>
                        <li><a href="<?php echo U('Shop/shoplist');?>" target="main">商家列表</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="nav-top-item">业务管理</a>
                    <ul>
                        <li><a href="<?php echo U('Shop/manapic');?>" target="main">门店轮播</a></li>
                    </ul>
                </li>
				<li>
