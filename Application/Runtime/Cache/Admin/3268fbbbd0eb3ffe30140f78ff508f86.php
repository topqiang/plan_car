	...
	<div class="content-box">
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tab1">
				<form action="<?php echo U('AdminBasic/delList',array('tname'=>'Goods'));?>" method="post">
					<table border="1">
						<!--标题-->
						<thead>
						<tr>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><img src="/elem/<?php echo ($vo["gpic"]); ?>" height="30" /></td>
								...
								<td>
                                    <?php if($vo['fstatus'] == 0): ?><a href="<?php echo U('Food/foodDown',array('gid'=>$vo['gid']));?>" title="下架">
                                        <img src="/elem/Public/Admin/images/icons/tick_circle.png" alt="Delete" />
                                    </a>
                                    <?php elseif($vo['gstatus'] == 1): ?>
                                    <a href="<?php echo U('Food/foodUp',array('gid'=>$vo['gid']));?>" title="上架">
                                        <img src="/elem/Public/Admin/images/icons/cross_circle.png" alt="Delete" />
                                    </a><?php endif; ?>
                                </td>
                                <td>
                                    <a href="<?php echo U('Goods/goodsEdit',array('id'=>$vo['gid']));?>" title="编辑">
                                        <img src="/elem/Public/Admin/images/icons/pencil.png" alt="Edit" />
                                    </a>
