                ...
                <form action="<?php echo U('WeiXinArticle/editTextBack');?>" method="post" class="form">
                    ...
                    <fieldset>
                        <p>
                            ...
                            <input class="text-input medium-input datepicker" type="text" name="wxa_keywords" value="<?php echo ($text_back['wxa_keywords']); ?>"/>*<br>
                            　　　　　　　<span style="color:#EC5B4D">多个关键词用空格隔开</span>
                        </p>
                        <p>
                            <span class="label">关键词类型：</span>
                            <input type="radio" name="wxa_keywords_type" value="1" <?php if($text_back['wxa_keywords_type'] == 1): ?>checked<?php endif; ?>/>完全匹配
                            <input type="radio" name="wxa_keywords_type" value="0" <?php if($text_back['wxa_keywords_type'] == 0): ?>checked<?php endif; ?>/>包含匹配
                        </p>
                        <p>
                            <span class="label">回答内容：　</span>
                            <textarea class="text-input textarea" name="wxa_description"><?php echo ($text_back['wxa_description']); ?></textarea>*<br>
