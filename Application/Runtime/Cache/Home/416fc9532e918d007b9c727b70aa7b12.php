...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/plancar/Public/Home/css/public.css" />
        <link href="/plancar/Public/Home/css/reset.css" rel="stylesheet"/>
        <script src="/plancar/Public/Home/js/jquery.min.js"></script>
        <script type="text/javascript" src="/plancar/Public/Home/js/yxMobileSlider.js" ></script>
        <script src="/plancar/Public/Home/js/public.js"></script>
        <style>
		   	...
		   	<div class="goods">
		   		...
		   		<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><div class="good" goodid="<?php echo ($good["id"]); ?>">
		   			...
		   			<div class="goodinfo zaocan">
		   				...
		   				<div class="level">
		   					<img src="/plancar/Public/Home/img/xing.png" />
		   					<img src="/plancar/Public/Home/img/xing.png" />
		   					<img src="/plancar/Public/Home/img/xing.png" />
		   				</div>
	...
	<script type="text/javascript" src="/plancar/Public/Home/js/touch.min.js"></script>
